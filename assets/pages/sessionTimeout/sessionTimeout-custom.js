...
! function(e) { "use strict";
    e.sessionTimeout = function(t) {
        ...
        var a, r = { title: "Sessão inativa!", message: "Sua sessão será encerrada automaticamente em 30 segundos.", logoutButton: "Sair", keepAliveButton: "Permanecer", keepAliveUrl: "Interna/index", ajaxType: "POST", ajaxData: "", redirUrl: "Interna/logout", logoutUrl: "Interna/logout", warnAfter: 9e5, redirAfter: 12e5, keepAliveInterval: 5e3, keepAlive: !0, ignoreUserActivity: !1, onStart: !1, onWarn: !1, onRedir: !1, countdownMessage: !1, countdownBar: !1, countdownSmart: !1 },
            d = r,
            l = {};
...
$(document).ready(function() {
    $.sessionTimeout({
        warnAfter: 1800000, //30 minutos( está em milissegundos) 1800000
        redirAfter: 1830000, //30 segundos 1830000
