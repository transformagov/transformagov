...
} elseif ($menu2 == 'DocumentosObrigatorios') {
    if (!isset($_POST['vaga'])) {
        echo "
...
} elseif ($menu2 == 'RequisitosDesejaveis') {
    if (!isset($_POST['vaga'])) {
        echo "
														<div class=\"row sub-title\" style=\"letter-spacing:0px\">
																<div class=\"col-lg-8\">
...
} elseif ($menu2 == 'AvaliacaoCurricular') {
    if (!isset($_POST['vaga'])) {
        echo "
                                                            <div class=\"row sub-title\" style=\"letter-spacing:0px\">
                                                                    <div class=\"col-lg-8\">
...
} elseif ($menu2 == 'AvaliacaoCompetencia') {
    if (!isset($_POST['vaga'])) {
        echo "
														<div class=\"row sub-title\" style=\"letter-spacing:0px\">
																<div class=\"col-lg-8\">
            ...
            foreach ($candidaturas as $linha) {
                ...
                if (isset($hbdi[$linha->pr_candidatura])) {
                    if ($hbdi[$linha->pr_candidatura] -> in_pergunta == '1') {
                        echo "4.1 O que?<br />";
                        ++$se;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_pergunta == '2') {
                        echo "4.2 Como?<br />";
                        ++$ie;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_pergunta == '3') {
                        echo "4.3 Por que?<br />";
                        ++$sd;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_pergunta == '4') {
                        echo "4.4 Quem?<br />";
                        ++$id;
                    }
                }
                ...
                if (isset($hbdi[$linha->pr_candidatura])) {
                    if ($hbdi[$linha->pr_candidatura] -> in_comportamento == '1') {
                        ...
                        ++$ie;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_comportamento == '2') {
                        echo "7.2 Gosto de compartilhar<br />";
                        ++$id;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_comportamento == '3') {
                        echo "7.3 Gosto de analisar<br />";
                        ++$se;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_comportamento == '4') {
                ...
                if (isset($hbdi[$linha->pr_candidatura])) {
                    if ($hbdi[$linha->pr_candidatura] -> in_procuro == '1') {
                        ...
                        ++$id;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_procuro == '2') {
                        echo "11.2 Uma visão organizada; detalhada; cronológica<br />";
                        ++$ie;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_procuro == '3') {
                        echo "11.3 Uma visão analítica; lógica; racional; de resultados<br />";
                        ++$se;
                    } elseif ($hbdi[$linha->pr_candidatura] -> in_procuro == '4') {
...
} elseif ($menu2 == 'AvaliacaoEspecialista') {
    if (!isset($_POST['vaga'])) {
        echo "
														<div class=\"row sub-title\" style=\"letter-spacing:0px\">
																<div class=\"col-lg-8\">
