...
if($this -> session -> perfil == 'candidato'){ //candidato
        ...
        echo "\">
                                            <a href=\"".base_url('Candidaturas/index')."\">
...
if($this -> session -> perfil == 'avaliador' || $this -> session -> perfil == 'avaliador_curriculo' || $this -> session -> perfil == 'sugesp' || $this -> session -> perfil == 'orgaos' || $this -> session -> perfil == 'administrador'){ 
        ...
        echo "\">
                                            <a href=\"".base_url('Candidaturas/ListaAvaliacao')."\">
                                                    <span class=\"pcoded-micon\"><i class=\"fa fa-pencil-square-o\"></i></span>
...
if($this -> session -> perfil == 'candidato' || $this -> session -> perfil == 'avaliador' || $this -> session -> perfil == 'sugesp'){ 
        ...
        echo "\">
                                            <a href=\"".base_url('Candidaturas/AgendamentoEntrevista')."\">
...
if($this -> session -> perfil == 'sugesp' || $this -> session -> perfil == 'orgaos' || $this -> session -> perfil == 'administrador'){ 
        ...
        echo "\">
                                            <a href=\"".base_url('Candidatos/ListaCandidatos')."\">
...
if($this -> session -> perfil == 'sugesp' || $this -> session -> perfil == 'orgaos' || $this -> session -> perfil == 'administrador'){ 
        ...
        echo "\">
                                            <a href=\"".base_url('Vagas/index')."\">
                                                    <span class=\"pcoded-micon\"><i class=\"fa fa-thumb-tack\"></i></span>
        ...
        echo "\">
                                            <a href=\"".base_url('GruposVagas/index')."\">
...
if($this -> session -> perfil == 'administrador'){ //administrador
        ...
        echo "\">
                                            <a href=\"".base_url('Interna/auditoria')."\">
        ...
        echo "\">
                                            <a href=\"".base_url('Usuarios/index')."\">
                                                    <span class=\"pcoded-micon\"><i class=\"fa fa-users\"></i></span>
...
echo " \" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Interna')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon-home-1\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Página inicial</span>
                                                                            </a>
                                                                    </li>";
if($this -> session -> perfil == 'candidato'){ //candidato
        echo "
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Candidaturas/index')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon-edit-1\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Suas candidaturas</span>
                                                                            </a>
                                                                    </li>";
}
if($this -> session -> perfil == 'avaliador' || $this -> session -> perfil == 'sugesp' || $this -> session -> perfil == 'orgaos' || $this -> session -> perfil == 'administrador'){ 
        echo "
                                                                    <li class=\"kt-menu__item";
        if(($this -> session -> perfil == 'avaliador' && $menu1 == 'Candidaturas' && $menu2 != 'AgendamentoEntrevista') || ($this -> session -> perfil != 'avaliador' && $menu1 == 'Candidaturas')){
                echo ' kt-menu__item--active';
        }
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Candidaturas/ListaAvaliacao')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon-edit-1\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Candidaturas</span>
                                                                            </a>
                                                                    </li>";
}
if($this -> session -> perfil == 'candidato' || $this -> session -> perfil == 'avaliador'){ 
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Candidaturas/AgendamentoEntrevista')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon-event-calendar-symbol\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Seus agendamentos</span>
                                                                            </a>
                                                                    </li>";
}
if($this -> session -> perfil == 'sugesp' || $this -> session -> perfil == 'orgaos' || $this -> session -> perfil == 'administrador'){ 
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Candidatos/ListaCandidatos')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon-avatar\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Candidatos</span>
                                                                            </a>
                                                                    </li>";
}
if($this -> session -> perfil == 'sugesp' || $this -> session -> perfil == 'orgaos' || $this -> session -> perfil == 'administrador'){ 
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Vagas/index')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon2-download-symbol\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Vagas</span>
                                                                            </a>
                                                                    </li>";
        echo "
                                                                    <li class=\"kt-menu__item";
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('GruposVagas/index')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon2-check-mark\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Grupos de vagas e questões</span>
                                                                            </a>
                                                                    </li>";
        echo "
                                                                    <li class=\"kt-menu__item";
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Relatorios/index')."\" class=\"kt-menu__link \">
...
if($this -> session -> perfil == 'administrador'){ //administrador
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Interna/auditoria')."\" class=\"kt-menu__link \">
                                                                                    <i class=\"kt-menu__link-icon flaticon2-gear\"></i>
                                                                                    <span class=\"kt-menu__link-text\">Auditoria</span>
                                                                            </a>
                                                                    </li>";
        echo "
                                                                    <li class=\"kt-menu__item";
        ...
        echo "\" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Usuarios/index')."\" class=\"kt-menu__link \">
...
echo "
                                                                    <li class=\"kt-menu__item \" aria-haspopup=\"true\">
                                                                            <a href=\"".base_url('Interna/logout')."\" class=\"kt-menu__link \">
                                                            ...
                                                            <div class=\"kt-header__topbar-item kt-header__topbar-item--user\">
                                                                    <div class=\"kt-header__topbar-wrapper\" data-toggle=\"dropdown\" data-offset=\"0px,0px\">
                                                                            <div class=\"kt-header__topbar-user\">
                                                                                    <span class=\"kt-header__topbar-username kt-hidden-mobile\">".$this -> session -> nome."</span>

                                                                                    <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                                                                                    <span class=\"kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold\">".substr($this -> session -> nome, 0, 1)."</span>
                                                                            </div>
                                                                    </div>
                                                                    <div class=\"dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl\">

                                                                            <!--begin: Head -->
                                                                            <div class=\"kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x\" style=\"background-image: url(".base_url('assets_6.0.3/media/misc/bg-1.jpg').")\">
                                                                                    <div class=\"kt-user-card__avatar\">
                                                                                            <!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
                                                                                            <span class=\"kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success\">".substr($this -> session -> nome, 0, 1)."</span>
                                                                                    </div>
...
if($this -> session -> perfil == 'candidato'){ //candidato
        echo "
                                                                                    <a href=\"".base_url('Candidatos/index')."\" class=\"kt-notification__item\">
...
echo "
                                                                                    <div class=\"kt-notification__custom kt-space-between\">
                                                                                            <a href=\"".base_url('Interna/logout')."\" class=\"btn btn-label btn-label-brand btn-sm btn-bold\"><i class=\"flaticon-logout\"></i> Sair</a>
                                                                                            <button type=\"button\" class=\"btn btn-clean btn-sm btn-bold\" data-toggle=\"modal\" data-target=\"#trocarsenha\"><i class=\"flaticon-edit\"></i> Alterar senha</button>
                                                                                    </div>
                                                                            </div>
