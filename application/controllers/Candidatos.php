...
class Candidatos extends CI_Controller
{
    ...
    {$this -> load -> model('Anexos_model');
        ...
        if ($this -> session -> perfil == 'candidato') {
            ...
            if ($this -> form_validation -> run() == false) {
                ...
                if ($this -> Candidatos_model -> update_candidato($dados_form)) {
                    $dados_candidato = $this -> Candidatos_model -> get_candidatos($this -> session -> candidato);
                    $dados = (array) $dados_candidato;
    ...
    public function cadastro()
    {
        ...
        if ($this -> form_validation -> run() == false) {
            ...
            if ($pr_candidato > 0) {
                if ($dados_form['Requisitos'] == '0' || $dados_form['Sentenciado'] == '1' || $dados_form['ProcessoDisciplinar'] == '1' || $dados_form['AjustamentoFuncionalPorDoenca'] == '1') {
                    //****************************
