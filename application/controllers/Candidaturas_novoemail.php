                        ...
                        if($this -> input -> post('cadastrar') != NULL){
                                ...
                                //confirma a existência de candidatura com documento pendente
                                        ...
                                        if (strlen($erro)>0){
                                                ...
                                                if($this -> input -> post('cadastrar') == 'Salvar dados'){
                                                        $this -> Candidaturas_model -> update_candidatura('dt_candidatura', date('Y-m-d H:i:s'),  $candidatura[0] -> pr_candidatura);
                                                        $this -> Usuarios_model -> log('sucesso', 'Candidaturas/Questionario', "Questionário da candidatura {$candidatura[0] -> pr_candidatura} salva com sucesso.", 'tb_candidaturas', $candidatura[0] -> pr_candidatura);
                                                        $dados['sucesso'] = "Dados salvos com sucesso.";
                                                        $dados['erro'] = '';
                        ...
                        if(isset($candidatura[0]) ){ //confirma a existência de candidatura com questionário pendente
                                ...
                                if($this -> input -> post('cadastrar') != NULL){
                                        ...
                                        if ($this -> form_validation -> run() == FALSE && isset($dados['questoes'])){
                                                ...
                                                if($this -> input -> post('cadastrar') == 'Salvar dados'){
                                                        $this -> Candidaturas_model -> update_candidatura('dt_candidatura', date('Y-m-d H:i:s'),  $candidatura[0] -> pr_candidatura);
                                                        $this -> Usuarios_model -> log('sucesso', 'Candidaturas/Questionario', "Documentação para a candidatura {$dados_form['candidatura']} salva com sucesso.", 'tb_candidaturas', $dados_form['candidatura']);
                                                        $dados['sucesso'] = "Dados salvos com sucesso";
                                                        $dados['erro'] = '';
                                                        $dados['respostas'] = $this -> Questoes_model -> get_respostas('',$candidatura[0]->pr_candidatura);
                                                        //redirect('Candidaturas/index');
...
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Agradecemos sua inscrição e esclarecemos as fases que compõem o processo seletivo da referida vaga e esclarecemos, de maneira pormenorizada, as etapas que compõem o processo seletivo para o qual você está inscrito:</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\"><strong>1. ANÁLISE CURRICULAR</strong></span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Na <strong>análise curricular</strong> são avaliados os currículos de todos os candidatos inscritos no processo de seleção, sob uma mesma “régua”, uma mesma medida de avaliação. Esta avaliação é imparcial e impessoal, sendo realizada pela equipe técnica do Programa Transforma Minas.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">O objetivo da etapa é diferenciar, entre os candidatos aqueles com perfil mais aderente ao que se espera da posição, com base nas informações inseridas pelos próprios candidatos no momento da inscrição. Portanto, são analisados o <strong>histórico acadêmico e profissional</strong>, o <b>conhecimento autodeclarado</b>, bem como a <b>motivação e elementos considerados relevantes para o ocupante do cargo.</b></span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Ao final da análise curricular, <b>os candidatos melhor avaliados</b>, passam para a fase subsequente, de entrevista por competências.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">A entrevista é on-line e o agendamento é feito pela equipe do Transforma Minas, que informa <b>ao candidato classificado para esta etapa</b>, o dia e o horário da mesma.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\"><b>2. ENTREVISTA</b></span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">A entrevista é utilizada para evidenciar competências comportamentais necessárias para a atuação no cargo. Mediante um roteiro pré-elaborado de questões, ao qual todos aqueles que chegaram a esta fase serão submetidos, os avaliadores verificarão evidências dos resultados obtidos por cada candidato em sua experiência profissional.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Os candidatos que demonstrarem o <b>melhor nível de desenvolvimento de competências comportamentais</b> avançam para a etapa final, onde a equipe do Governo definirá, com base no dossiê elaborado pela equipe do Transforma Minas.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\"><b>3. TESTE DE ADERÊNCIA</b></span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Em paralelo ao período de Entrevista por Competência, os candidatos que serão entrevistados receberão um link para realizarem o Teste de Aderência. Tal teste é obrigatório, mas não é eliminatório e busca conhecer um pouco mais o candidato.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\"><b>4. ENTREVISTA COM ESPECIALISTA e/ou ENTREVISTA FINAL</b></span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Submetem-se à entrevista com o especialista e/ou entrevista final, todos aqueles candidatos melhores classificados na etapa de Entrevista por Competência.  O objetivo desta fase do processo seletivo é verificar conhecimentos específicos na área requisitada pela vaga, de sua trajetória profissional e motivações para atuar num cargo de liderança no setor público.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\"><b>5. FINALIZAÇÃO DO PROCESSO SELETIVO</b></span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Ao final do processo a equipe do Governo definirá, com base no dossiê com todas as informações acumuladas sobre os candidatos o ocupante do cargo da vaga. É importante salientar que os processos seletivos no âmbito do Transforma Minas se diferem de um concurso público. Trata-se de uma importante inovação na forma de condução aos cargos estratégicos do Governo de Minas.</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Portanto, é preciso que fique claro que <b>não haverá</b> publicização de resultados intermediários entre as fases de análise curricular e entrevista(s). Cada candidato receberá, individualmente, o retorno sobre sua continuidade ou não no processo seletivo, com base nas metodologias anteriormente apresentadas (conforme critérios de análise curricular e de avaliação por competências estabelecidos).</span></p>
<p style=\"font-size: 18px; text-align: justify; line-height: 1.6; word-break: break-word; mso-line-height-alt: 25px; margin: 0;\"><br/><span style=\"color: #000000; font-size: 18px; mso-ansi-font-size: 18px;\">Sendo assim, <b>consulte periodicamente o e-mail que você nos informou no momento da sua inscrição. Ele é o principal meio de contato entre a equipe gestora do processo seletivo e o candidato.</b></span></p>
...
<!--[if (IE)]></div><![endif]-->
                                                                ...
                                                                $this -> Usuarios_model -> log('sucesso', 'Candidaturas/Questionario', "Documentação para a candidatura {$dados_form['candidatura']} enviada com sucesso.", 'tb_candidaturas', $dados_form['candidatura']);
                                                        }
                                                }
                                        }
...
<!--[if (IE)]></div><![endif]-->
	...
	public function DetalheAvaliacao($candidatura,$link=null){ //lista de candidaturas - perfil gestores e avaliador
...
<!--[if (IE)]></div><![endif]-->
                                        ...
                                        $this -> Candidaturas_model -> update_candidatura('dt_candidatura', date('Y-m-d H:i:s'),  $candidatura[0] -> pr_candidatura);
                                        $this -> Usuarios_model -> log('sucesso', 'Candidaturas/AvaliacaoEntrevistaEspecialista', "Entrevista da candidatura {$dados_form['candidatura']} inserida com sucesso.", 'tb_candidaturas', $dados_form['candidatura']);
                                        if($dados['vaga'] > 0){
                                                redirect('Vagas/resultado/'.$dados['vaga']);
                                        }
                                        else{
                ...
                if(strlen($this -> input -> post('salvar')) > 0){
                        ...
                        if ($this -> form_validation -> run() == FALSE){
								...
								if($this -> input -> post('salvar') == 'Concluir avaliação'){
										...
										$this -> Usuarios_model -> log('sucesso', 'Candidatos/AvaliacaoCurriculo', "Análise de currículo da candidatura {$dados_form['candidatura']} salva com sucesso.", 'tb_candidaturas', $dados_form['candidatura']);
...
<!--[if (IE)]></div><![endif]-->
										...
										$this -> Usuarios_model -> log('sucesso', 'Candidatos/AvaliacaoCurriculo', "Candidatura {$candidatura -> pr_candidatura} reprovada na análise curricular.", 'tb_candidaturas', $candidatura -> pr_candidatura);
										//*********************
										$this -> email -> from($this -> config -> item('email'), $this -> config -> item('nome'));
										$this -> email -> to($candidato -> vc_email);
...
<!--[if (IE)]></div><![endif]-->
        ...
        public function eliminar_entrevista($id,$vaga=''){
                ...
                $this -> Candidaturas_model -> update_candidatura('dt_candidatura', date('Y-m-d H:i:s'),  $candidatura[0] -> pr_candidatura);
                $this -> Usuarios_model -> log('sucesso', 'Candidaturas/AvaliacaoEntrevista', "Candidatura {$id} eliminado por não comparecimento.", 'tb_candidaturas', $id);
                if(strlen($vaga) > 0){
